...
const test = (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "text-lg text-green-600 p-5" },
    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1", null, "Options"),
    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("img", { src: "assets/samamentor.jpg", alt: "y" })));
